...
export const containsInstanceId = (node: TreeGoal, instanceId: InstanceId): boolean => (
...
export const {
    addGoal, addGoalToTab, setTreeData, setChildrenOfNodeId, moveTreeItem, addGoalToTree, connectGoalInstances, addGoalsToTree,
