...
import {getSymbolKeyByType, formatFuncGoalRefId, formatNonFuncGoalRefId} from "../utils/GraphUtils";
...
export const renderFunction = (
    ...
    const goalName = formatFuncGoalRefId(goal)
...
export const renderNonFunction = (
    ...
    // type  Negative
    // descriptions {id: 5, content: 'Concern'}
    ...
    // 
    const nonFuncGoalName = formatNonFuncGoalRefId(descriptions)
