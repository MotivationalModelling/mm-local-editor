...
const papers: {
  ...
  {
    title: "Paper_Motivational_Goals_EHR _2",
    link: "Paper_Motivational_Goals_EHR _2.pdf",
  },
  { title: "RECameraReady", link: "RECameraReady.pdf" },
  {
    title: "Requirements elicitation and specification using the agent paradi",
    link: "Requirements elicitation and specification using the agent paradi.pdf",
  },
  {
    title: "Using_Goal_Models_in_Agile_Teaching__RE_",
    link: "Using_Goal_Models_in_Agile_Teaching__RE_.pdf",
  },
